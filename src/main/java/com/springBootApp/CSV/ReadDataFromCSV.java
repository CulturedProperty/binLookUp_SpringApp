...
public class ReadDataFromCSV {
    ...
    public static String readDataFromCsv(long binValue) throws IOException, CsvException {
        String s = "";
        String fileName = "C:\\Users\\Sapteru\\Downloads\\File\\MC-SBART\\latest_sorted.csv";
        try (CSVReader reader = new CSVReader(new FileReader(fileName))) {
            ...
            FileWriter file = new FileWriter("C:\\Users\\Sapteru\\Downloads\\File\\MC-SBART\\binRecord.json");
            file.write(jsonObject.toJSONString());
            file.close();
            String path = "C:\\Users\\\\Sapteru\\Downloads\\File\\MC-SBART\\binRecord.json";
            try {
